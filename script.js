...
new TypeIt("#teks1", {
  strings: ["Happy birthday, Mala! 🎂✨May this special day bring you immense happiness, filled with sincere smiles from those who love you.", "May every step you take bring blessings, and may every prayer you offer be answered by Allah SWT.", "I pray that Mala will always be blessed with perfect health, a long and fruitful life, abundant blessings, a heart full of peace, and be surrounded by love and good friends.", "" , "May your life journey be ever more beautiful, filled with valuable experiences, and may Allah always protect you from all evil."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Semoga apa pun yang sedang kamu impikan perlahan menjadi nyata, dan jika pun ada kesulitan","Allah beri kamu kekuatan untuk melewatinya dengan hati yang sabar.", " ", "Happy Birthday yaa malaa, terima kasih sudah bertahan sampai sejauh ini.", " ", " Wish you all the best, -Adit."],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
